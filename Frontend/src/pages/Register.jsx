  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 py-12 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        {/* Card */}
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-2xl rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-8 sm:p-10 hover:shadow-purple-500/10 hover:shadow-3xl transition-all duration-500 hover:border-purple-300/50 dark:hover:border-purple-600/50">
          <div className="mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-gray-900 via-purple-900 to-pink-900 dark:from-white dark:via-purple-200 dark:to-pink-200 bg-clip-text text-transparent leading-tight animate-gradient">
              Create Account
            </h2>
            ...
            <div className="flex items-center space-x-2 mt-3">
              ...
              <span className="text-xs text-gray-500 dark:text-gray-400">Free Forever</span>
            </div>
          </div>
